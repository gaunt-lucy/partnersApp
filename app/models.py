...
class User(UserMixin, db.Model):
	...
	def bulk_add_users():
		users = [ ("Thibaut","Kemmer","tkemmer0@accuweather.com"),\
				("Michael","Cumberland","mcumberland1@nydailynews.com"),\
				("Lyndsey","Mingaye","lmingaye2@chron.com"),\
				("Hobart","Carek","hcarek3@goo.gl"),\
				("Orren","Weedon","oweedon4@washingtonpost.com"),\
				("Crichton","Crottagh","ccrottagh5@redcross.org"),\
				("Ki","Disney","kdisney6@netvibes.com"),\
				("Jennica","Waggett","jwaggett7@mysql.com"),\
				("Vergil","Edds","vedds8@github.com"),\
				("Glenda","Fesby","gfesby9@usnews.com"),\
				("Rafaelia","Youel","ryouela@com.com"),\
				("Brena","Burchess","bburchessb@stumbleupon.com"),\
				("Carmelia","Scrange","cscrangec@webs.com"),\
				("Elisabeth","Chitty","echittyd@bbc.co.uk"),\
				("Valina","Seelbach","vseelbache@freewebs.com"),\
				("Estrellita","Preto","epretof@bizjournals.com"),\
				("Dylan","Anfonsi","danfonsig@tuttocitta.it"),\
				("Osborn","Brozsset","obrozsseth@sourceforge.net"),\
				("Camellia","Tarling","ctarlingi@hao123.com"),\
				("Donaugh","Seary","dsearyj@hp.com"),\
				("Manny","Grenshields","mgrenshieldsk@cyberchimps.com"),\
				("Ange","Tuttiett","atuttiettl@ed.gov"),\
				("Wilie","Devonshire","wdevonshirem@engadget.com"),\
				("Omero","Grundey","ogrundeyn@4shared.com"),\
				("Geneva","Bonsul","gbonsulo@cam.ac.uk"),\
				("Dell","Sandell","dsandellp@free.fr"),\
				("Carol","Poxton","cpoxtonq@seattletimes.com"),\
				("Lazaro","MacMechan","lmacmechanr@furl.net"),\
				("Marthena","Smalley","msmalleys@dell.com"),\
				("Pace","Monckman","pmonckmant@tinyurl.com"),\
				("Colin","Le Jean","clejeanu@walmart.com"),\
				("Burl","Derrington","bderringtonv@pen.io"),\
				("Courtnay","Stockall","cstockallw@miitbeian.gov.cn"),\
				("Creigh","Giacomozzo","cgiacomozzox@who.int"),\
				("Vita","Sinnie","vsinniey@aol.com"),\
				("Lynnelle","Adamovitz","ladamovitzz@boston.com"),\
				("Nicholas","Hamblyn","nhamblyn10@istockphoto.com"),\
				("Xavier","Ludlow","xludlow11@mtv.com"),\
				("Chrotoem","Roistone","croistone12@chronoengine.com"),\
				("Shirlee","Spykings","sspykings13@whitehouse.gov"),\
				("Buiron","Faldoe","bfaldoe14@cdbaby.com"),\
				("Pru","Darey","pdarey15@ox.ac.uk"),\
				("Deborah","Grange","dgrange16@buzzfeed.com"),\
				("Don","Stolte","dstolte17@nature.com"),\
				("Florance","Kliemke","fkliemke18@wikia.com"),\
				("Agnesse","Merfin","amerfin19@loc.gov"),\
				("Amy","Jadczak","ajadczak1a@tinyurl.com"),\
				("Tania","Juorio","tjuorio1b@ftc.gov"),\
				("Muhammad","Ast","mast1c@hibu.com"),\
				("Dalston","Alexsandrowicz","dalexsandrowicz1d@bluehost.com"),\
				("Nickola","Lauridsen","nlauridsen1e@amazon.de"),\
				("Margette","Van Arsdalen","mvanarsdalen1f@newyorker.com"),\
				("Kahlil","Sprowles","ksprowles1g@addthis.com"),\
				("Marcel","Allridge","mallridge1h@naver.com"),\
				("Shaughn","Behninck","sbehninck1i@dmoz.org"),\
				("Caitrin","Gribbell","cgribbell1j@washington.edu"),\
				("Enrika","Keningley","ekeningley1k@mac.com"),\
				("Dennis","Dempsey","ddempsey1l@disqus.com"),\
				("Michaelina","Simes","msimes1m@hubpages.com"),\
				("Stanly","Gonnin","sgonnin1n@last.fm"),\
				("Vikky","Strother","vstrother1o@paypal.com"),\
				("Melesa","Antonignetti","mantonignetti1p@google.it"),\
				("Jana","Lande","jlande1q@msu.edu"),\
				("Penny","Scholefield","pscholefield1r@yellowpages.com"),\
				("Tyler","Cussins","tcussins1s@wsj.com"),\
				("Zed","Benka","zbenka1t@icio.us"),\
				("Nils","Goretti","ngoretti1u@businessweek.com"),\
				("Cchaddie","Ewert","cewert1v@barnesandnoble.com"),\
				("Marlo","Abberley","mabberley1w@google.cn"),\
				("Leila","McKune","lmckune1x@discovery.com"),\
				("Blondy","Rocca","brocca1y@aboutads.info"),\
				("Stillman","Sreenan","ssreenan1z@wiley.com"),\
				("Andrew","Dimitriou","adimitriou20@chicagotribune.com"),\
				("Monika","Lillistone","mlillistone21@linkedin.com"),\
				("Ebonee","Stanmore","estanmore22@dot.gov"),\
				("Jerrine","Pickavant","jpickavant23@pen.io"),\
				("Dun","Cow","dcow24@google.com.hk"),\
				("Skipper","Cannaway","scannaway25@hugedomains.com"),\
				("Fabiano","Alcott","falcott26@goo.gl"),\
				("Quentin","Watters","qwatters27@bizjournals.com"),\
				("Simone","Longmire","slongmire28@ucoz.com"),\
				("Fonz","McGunley","fmcgunley29@pinterest.com"),\
				("Augustine","Gurrado","agurrado2a@ovh.net"),\
				("Aurel","Briant","abriant2b@dedecms.com"),\
				("Addia","Lowles","alowles2c@newyorker.com"),\
				("Jerad","Wilkisson","jwilkisson2d@dropbox.com"),\
				("Crystal","Mochar","cmochar2e@mlb.com"),\
				("Hildegaard","Halsall","hhalsall2f@photobucket.com"),\
				("Anissa","Rames","arames2g@about.com"),\
				("Krystle","Timmens","ktimmens2h@youku.com"),\
				("Chan","Willmott","cwillmott2i@naver.com"),\
				("Jodi","Elph","jelph2j@bbb.org"),\
				("Blisse","Esposi","besposi2k@newsvine.com"),\
				("Jarred","Rosbotham","jrosbotham2l@squarespace.com"),\
				("Nancie","Bugdall","nbugdall2m@cmu.edu"),\
				("Cathleen","Hunnisett","chunnisett2n@pcworld.com"),\
				("Maurise","Reboul","mreboul2o@usatoday.com"),\
				("Emmaline","Venard","evenard2p@tumblr.com"),\
				("Miltie","Scamwell","mscamwell2q@yellowbook.com"),\
				("Aida","Ivankovic","aivankovic2r@quantcast.com")]
...
class Partner(db.Model):
	...
	def bulk_add_partners():
		partners = [ ("Yerevan State University", "Yerevan State University", "HEI", "AM", "Yerevan", "24", datetime.today()),\
					("Universities UK, BEC.AR Argentina Government", "Universities UK, BEC.AR Argentina Government", "HEI", "AR", "Argentina", "91", datetime.today()),\
					("Universities UK, BEC.AR Argentina Government", "Universities UK, BEC.AR Argentina Government", "HEI", "AR", "Argentina", "105", datetime.today()),\
